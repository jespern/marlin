...
(Migration status, 2026-09-04: every module is converted except
`daemon/daemon.zig`, which had uncommitted work in flight at the time. Move
its tests when that work lands.)
