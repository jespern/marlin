...
const shimmer_shades = render.shimmer_shades;
...
const legacy_rehydration_prefix = render.legacy_rehydration_prefix;
...
const languageForPath = render.languageForPath;
const diffLanguage = render.diffLanguage;
const wordIn = render.wordIn;
const isKeyword = render.isKeyword;
const isBuiltinType = render.isBuiltinType;
const isConstant = render.isConstant;
const isIdentStart = render.isIdentStart;
const isIdentContinue = render.isIdentContinue;
const lineCommentMarker = render.lineCommentMarker;
const appendSyntaxSpan = render.appendSyntaxSpan;
const syntaxSpans = render.syntaxSpans;
const isShellOperator = render.isShellOperator;
const shellOperatorEnd = render.shellOperatorEnd;
const shellOperatorExpectsCommand = render.shellOperatorExpectsCommand;
const isShellWrapper = render.isShellWrapper;
const isShellPath = render.isShellPath;
const shellCommandSpans = render.shellCommandSpans;
const gitLogSpans = render.gitLogSpans;
const isUrlStart = render.isUrlStart;
const isUrlTerminator = render.isUrlTerminator;
const countByte = render.countByte;
...
const linkForBytes = render.linkForBytes;
...
const appendColumns = render.appendColumns;
...
const appendInlineStyle = markdown.appendInlineStyle;
const inlineMarkdown = markdown.inlineMarkdown;
const stylesForChunk = markdown.stylesForChunk;
...
const appendMarkdownLine = markdown.appendMarkdownLine;
const tableCells = markdown.tableCells;
const isTableDelimiter = markdown.isTableDelimiter;
const TableBorder = markdown.TableBorder;
const appendTableBorder = markdown.appendTableBorder;
const appendTranslatedInline = markdown.appendTranslatedInline;
const appendTableRow = markdown.appendTableRow;
const appendTable = markdown.appendTable;
const languageForFence = markdown.languageForFence;
const expandCodeTabs = markdown.expandCodeTabs;
const appendCodeBorder = markdown.appendCodeBorder;
const decimalDigits = markdown.decimalDigits;
const appendCodeBlock = markdown.appendCodeBlock;
const CalloutKind = markdown.CalloutKind;
const calloutLabel = markdown.calloutLabel;
const calloutAccent = markdown.calloutAccent;
const calloutMarker = markdown.calloutMarker;
const semanticCallout = markdown.semanticCallout;
const decorateCalloutLines = markdown.decorateCalloutLines;
const appendCallout = markdown.appendCallout;
const ListItem = markdown.ListItem;
const parseListItem = markdown.parseListItem;
const headingLevel = markdown.headingLevel;
const isHorizontalRule = markdown.isHorizontalRule;
const ensureBlankLine = markdown.ensureBlankLine;
