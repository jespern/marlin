...
pub const Palette = struct {
    ...
    /// Reasoning commentary has the same foreground priority as assistant
    /// prose while retaining its small mark and flat, unfilled layout.
    pub const reasoning: vaxis.Style = assistant;
