...
pub const Store = struct {
    ...
    pub fn kvGetInt(self: Store, key: []const u8) Error!i64 {
    ...
    pub fn prepare(self: Store, comptime sql: [:0]const u8) Error!*c.sqlite3_stmt {
...
pub fn bindInt(stmt: *c.sqlite3_stmt, idx: c_int, v: i64) void {
