...
pub const spec_schema =
    \\{"type":"object","properties":{"prompt":{"type":"string","minLength":1},"model":{"type":"string","minLength":1},"effort":{"type":"string","enum":["auto","none","minimal","low","medium","high","xhigh","max"]},"max_rounds":{"type":"integer","minimum":1,"maximum":32}},"required":["prompt"],"additionalProperties":false}
;
