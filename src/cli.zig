...
pub fn dispatch(
    ...
    switch (cmd) {
        ...
        .plugin => return headless.plugin(gpa, io, environ, self_exe, rest),
...
const help_text =
    ...
    \\  marlin plugin [list|marketplace add <repo>|marketplace update <name>|install <plugin>@<marketplace>|uninstall <plugin>@<marketplace>]
